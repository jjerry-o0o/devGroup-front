    ...
    <header className="fixed top-0 z-10 w-full flex items-center justify-center bg-white shadow-md">
      <div className="w-full max-w-[1800px] flex items-center justify-between px-4 py-3">
        ...
        <div className="flex gap-5 items-center">
          ...
          <div className="font-medium text-[#24292e] text-[18px]">Support</div>
        </div>
        {/* 우측 */}
        <div className="flex items-center gap-3">
          {/*검색창*/}
          <label htmlFor="search" className="flex border w-92 h-8 border-[#24292e] rounded-sm justify-end items-center px-3">
          ...
          {/*로그인 + 토글*/}
          <div className="text-[#24292e] hover:bg-[#667eea] hover:text-white px-2 py-1 rounded-sm transition-all duration-300 text-[16px]">
            Login / Join
            <div className=""></div>
          </div>
        </div>
